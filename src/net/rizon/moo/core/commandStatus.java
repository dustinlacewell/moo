...
public class commandStatus extends command
{
	...
	{
		moo.sock.reply(source, target, "[STATUS] " + moo.conf.getNick() + " version " + moo.conf.getVersion() + ", created on " + moo.getCreated() + ". Using " + Thread.activeCount() + " threads and " + this.getMemory() + " of memory");
	}
}