...
public class moo
{
	...
	private static final String[] commands = { "commandFlood", "commandMap", "commandScheck", "commandShell", "commandShutdown", "commandSid", "commandSplit", "commandStatus", "commandVersions" };
