...
public class moo
{
	...
	private static final String[] commands = { "commandFlood", "commandHelp", "commandMap", "commandReload", "commandScheck", "commandShell", "commandShutdown", "commandSid", "commandSplit", "commandStatus", "commandVersions" };
