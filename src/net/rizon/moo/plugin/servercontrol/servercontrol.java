...
import net.rizon.moo.plugin.servercontrol.commands.CommandAddServer;
import net.rizon.moo.plugin.servercontrol.commands.CommandClose;
import net.rizon.moo.plugin.servercontrol.commands.CommandConnections;
import net.rizon.moo.plugin.servercontrol.commands.CommandDelServer;
import net.rizon.moo.plugin.servercontrol.commands.CommandServerControl;
import net.rizon.moo.plugin.servercontrol.commands.CommandServers;
import net.rizon.moo.plugin.servercontrol.commands.CommandShortcut;
import net.rizon.moo.plugin.servercontrol.protocols.FTP;
import net.rizon.moo.plugin.servercontrol.protocols.SSH;
import net.rizon.moo.plugin.servercontrol.protocols.Telnet;
